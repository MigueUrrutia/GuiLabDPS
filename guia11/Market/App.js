...
function MyStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="ListarProductos" component={ListarProductos} options={{ title: "Productos" }} />
      <Stack.Screen name="Details" component={PaginaDetalle} options={{ title: "Editar Producto" }} />
